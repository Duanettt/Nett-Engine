...
public:
    ...
    void ProcessKeyboard(Camera_Movement direction, float deltaTime)
    {
        ...
        if (direction == DOWN)
        {
            Position += -Up * velocity; // Negative up is basically down :D
        }
    }

    void ProcessKeyboard(Camera_Instruction instruction, float deltaTime)
    {
        std::cout << "Movement Speed is: " << MovementSpeed << std::endl;
